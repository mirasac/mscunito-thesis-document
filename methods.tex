...
\Gls{vulnerability} data are divided in \gls{adaptive_capacity} and \gls{sensitivity}. Under adaptive capacity are gathered measures which are active, planned or not present for the system in order to contain negative \glspl{impact} of climate. They are listed in table~\ref{tab:drivers_adaptive_capacity} and derived from \cite[558]{2022DeVivoRiskAssessment}. \Glspl{driver} of sensitivity are elements of the system subject directly to the realisation of risks. They are collected from \cite[555-556]{2022DeVivoRiskAssessment} and presented in table~\ref{tab:drivers_sensitivity}.
