...
\begin{equation}
  ...
  R(\underline{x}) = \frac{w_E E + w_H H(\underline{x}) + w_V V}{w_E + w_H + w_V}
  \quad .
\end{equation}
...
\begin{equation}
  ...
  R(\underline{x}) = c_0 + \frac{w_H H(\underline{x})}{w_E + w_H + w_V} = c_0 + c_1 \sum_j \sum_{I \in \mathcal{H}_j} w_I I(\underline{x}_I)
\end{equation}
...
\begin{equation}
  ...
  r(\underline{x}) =
  \begin{cases}
    \riski & R(\underline{x}) < q_1 \\
    \riskii & q_1 \le R(\underline{x}) < q_2 \\
    \riskiii & q_2 \le R(\underline{x}) < q_3 \\
    \riskiv & q_3 \le R(\underline{x}) < q_4 \\
    \riskv & R(\underline{x}) \ge q_4
  \end{cases}
  \quad .
\end{equation}
