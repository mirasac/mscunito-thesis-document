...
\begin{figure}[h]
  ...
  \caption{First two \glspl{EOF} of indicator $\mathrm{HWML}$ for model EC-Earth3 in the reference period. Values are normalised with $L^2$ norm, they are visualised as spatial distribution and represent the weight of each grid cell on the indicator.}
