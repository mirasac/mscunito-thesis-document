...
\begin{equation}
  ...
  I(y, x, \underline{z}) = \frac{1}{\abs{S_\text{y}}} \sum_{t \in S_\text{y}} (y, x, t, \underline{z})
  \quad .
\end{equation}
...
\begin{equation}
  ...
  \frac{I - I_\text{clim}}{I_\text{clim}}
  \quad ,
\end{equation}
...
\end{equation}
where $\underline{z}_I$ is the sequence of values for parameters which are arguments of $I$.
