...
\footnote{In literature different terms are used to refer to \glspl{driver} within the \gls{exposure}, e.g. ``assets'' or ``exposed sample'' in \cite{2022DeVivoRiskAssessment}.}
\begin{example}
