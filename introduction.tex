...
Data specific to the study and any elaboration applied to them are then presented in chapter~\ref{sec:Data and Methods}. Section~\ref{sec:Methodology of risk assessment} in particular describes the methodology of \gls{CCRA} which is followd in this work.

Results of the application of the methodology to the case study and the consequent \gls{SA} are in chapter~\ref{sec:Results and Discussion}, while chapter~\ref{sec:Conclusions} summarises the final considerations on this study.
