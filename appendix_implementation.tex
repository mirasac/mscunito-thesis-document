...
Some models available in \NEX are excluded from the present study because they present issues which can not be contained without affecting the calculations. Table~\ref{tab:CMIP6_models} list both the used models and the excluded models, along with additional information.
...
\begin{table}[h]
  \centering
  \caption{Models available in \NEX. The part of the table above the line shows the models used in the present study, their \gls{CMIP6} variant is specified. Below the line the models which are excluded are listed, along with the reason for their exclusion.}
