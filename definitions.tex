...
\begin{description}
  \item[determinant] Any component of risk, i.e. hazard, exposure, vulnerability, response, from \cite[493]{2021SimpsonAFramework}.
  ...
  resources'', from \cite[2233]{2021MatthewsAnnexVII}. Note that this concept focues on the negative impacts of the physical drivers, the term \emph{Climatic impact-driver} is used for conditions with more general impacts (cfr. \cite[2224]{2021MatthewsAnnexVII}, \cite[10]{2020ReisingerTheConcept} and \cite[1871]{2021RanasingheClimateChange}). In this document the term Driver is used (cfr. definition~\ref{def:driver}).
  \label{def:driver}\item[driver] Individual components of determinants, from \cite[493]{2021SimpsonAFramework}.
