...
\begin{column}{0.45\textwidth}
  \begin{enumerate}
    ...
    \begin{center}
      \begin{tabular}{ccc}
        \includegraphics[width=0.30\columnwidth]{tasmin_anomaly_preprocessed} & \includegraphics[width=0.30\columnwidth]{tasmax_anomaly_preprocessed} & \includegraphics[width=0.30\columnwidth]{pr_anomaly_preprocessed} \\
        \includegraphics[width=0.30\columnwidth]{tasmin_anomaly_adjusted} & \includegraphics[width=0.30\columnwidth]{tasmax_anomaly_adjusted} & \includegraphics[width=0.30\columnwidth]{pr_anomaly_adjusted}
      \end{tabular}
    \end{center}
...
\begin{frame}{Evaluation of hazard indicators}
  \begin{enumerate}
    ...
    % MC add downsampled quantile plot for temperature and precipitation.
