...
\begin{frame}{Introduction}
  \begin{itemize}
    ...
    \begin{center}
      \includegraphics[keepaspectratio=true,width=0.8\textheight]{nomenclature}
    \end{center}
...
\begin{column}{0.60\textwidth}
  \begin{enumerate}
    ...
    % MC insert here the explicit formula for risk which is linear.
...
\begin{frame}{Heat wave frequency}
  \begin{center}
    ...
    % MC put title with scenario and year!
\end{center}
\end{frame}
